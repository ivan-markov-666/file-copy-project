...
const comment_stripper_1 = require("./comment-stripper");
/**
 ...
 */
async function readBlacklist(blacklistPath) {
    const blacklist = [];
    try {
 ...
 */
async function scanDirectory(dirPath, blacklist, outputStream, basePath, stats, includeEnvFiles, stripComments) {
    try {
        ...
        for (const entry of entries) {
            ...
            if (entry.isDirectory()) {
                ...
                try {
                    ...
                    if (stripComments) {
                        content = (0, comment_stripper_1.stripCommentsFromFile)(content, fullPath);
                    }
